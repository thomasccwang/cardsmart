...
<div class="nav" role="navigation">
	<ul>
		...
		<li><a href="${createLink(action: 'index')}" id="reload-link">Update Map</a></li>
		<li><g:link class="list" controller='cardIssuer' action="list">Issuers</g:link></li>
		<li><g:link class="list" controller='card' action="list">Cards</g:link></li>
		<li><g:link class="list" controller='cardReward' action="list">Rewards</g:link></li>
		<li><g:link class="list" controller='yelpCategory' action="list">Categories</g:link></li>
	</ul>
</div>
