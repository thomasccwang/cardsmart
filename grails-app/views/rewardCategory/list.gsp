...
<html>
	...
	<body>
		<a href="#list-rewardCategory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-rewardCategory" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'rewardCategory.name.label', default: 'Name')}" />
				...
				<tbody>
				<g:each in="${rewardCategoryInstanceList}" status="i" var="rewardCategoryInstance">
			...
			<div class="pagination">
				<g:paginate total="${rewardCategoryInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
